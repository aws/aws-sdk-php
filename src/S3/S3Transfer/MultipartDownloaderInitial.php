...
abstract class MultipartDownloaderInitial implements PromisorInterface
{
    ...
    ): string
    {
        return match ($multipartDownloadType) {
            MultipartDownloaderInitial::PART_GET_MULTIPART_DOWNLOADER => PartGetMultipartDownloader::class,
            MultipartDownloaderInitial::RANGE_GET_MULTIPART_DOWNLOADER => RangeGetMultipartDownloader::class,
            default => throw new \InvalidArgumentException(
                ...
                ."\n"
                . "\t* " . MultipartDownloaderInitial::RANGE_GET_MULTIPART_DOWNLOADER
            )
        };
    }
}