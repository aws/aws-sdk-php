 ...
 * @phpstan-method \Aws\Result createEventBus(array{Name?: string, EventSourceName?: string, Tags?: list<array{Key?: string, Value?: string, ...}>, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise createEventBusAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise createEventBusAsync(array{Name?: string, EventSourceName?: string, Tags?: list<array{Key?: string, Value?: string, ...}>, ...} $args = [])
 ...
 *     NamePrefix?: string,
 *     ConnectionState?: 'AUTHORIZED'|'AUTHORIZING'|'CREATING'|'DEAUTHORIZED'|'DEAUTHORIZING'|'DELETING'|'UPDATING',
 *     NextToken?: string,
 *     Limit?: int,
 *     ...,
 * } $args = [])
 ...
 * @phpstan-method \Aws\Result updateArchive(array{ArchiveName?: string, Description?: string, EventPattern?: string, RetentionDays?: int, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise updateArchiveAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise updateArchiveAsync(array{ArchiveName?: string, Description?: string, EventPattern?: string, RetentionDays?: int, ...} $args = [])
