<?php return [
  'operations' => [
    ...
    'DeleteSpotDatafeedSubscription' => '<p>Deletes the datafeed for Spot Instances. For more information, see <a href="http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html">Spot Instances</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>',
    ...
    'DescribeSpotDatafeedSubscription' => '<p>Describes the datafeed for Spot Instances. For more information, see <a href="http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html">Spot Instances</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>',
  ...
  'shapes' => [
    ...
    'DatafeedSubscriptionState' => [
      'base' => NULL,
      'refs' => [
        'SpotDatafeedSubscription$State' => '<p>The state of the Spot Instance datafeed subscription.</p>',
      ],
    ],
    'DateTime' => [
      'base' => NULL,
      'refs' => [
        ...
        'DescribeSpotPriceHistoryRequest$StartTime' => '<p>The start date and time of the Spot Price history data.</p>',
        'DescribeSpotPriceHistoryRequest$EndTime' => '<p>The end date and time of the Spot Price history data.</p>',
    ...
    'GroupIdentifierList' => [
      ...
      'refs' => [
        ...
        'LaunchSpecification$SecurityGroups' => '<p>One or more security groups. If requesting a Spot Instance in a nondefault VPC, you must specify the security group ID. If requesting a Spot Instance in EC2-Classic or a default VPC, you can specify either the security group name or ID.</p>',
    ...
    'InstanceType' => [
      ...
      'refs' => [
        ...
        'LaunchSpecification$InstanceType' => '<p>The instance type.</p> <p>Default: <code>m1.small</code></p>',
        ...
        'RequestSpotLaunchSpecification$InstanceType' => '<p>The instance type.</p> <p>Default: <code>m1.small</code></p>',
      ],
    ],
    'InstanceTypeList' => [
      'base' => NULL,
      'refs' => [
        'DescribeSpotPriceHistoryRequest$InstanceTypes' => '<p>One or more instance types.</p>',
      ],
    ],
    'Integer' => [
      'base' => NULL,
      'refs' => [
        ...
        'CreateVolumeRequest$Size' => '<p>The size of the volume, in GiBs.</p> <p>Constraints: If the volume type is <code>io1</code>, the minimum size of the volume is 4 GiB.</p> <p>Default: If you\'re creating the volume from a snapshot and don\'t specify a volume size, the default is the snapshot size.</p>',
        ...
        'DescribeSpotPriceHistoryRequest$MaxResults' => '<p>The number of rows to return.</p>',
        ...
        'EbsBlockDevice$VolumeSize' => '<p>The size of the volume, in GiB.</p> <p>Constraints: If the volume type is <code>io1</code>, the minimum size of the volume is 10 GiB; otherwise, the minimum size is 1 GiB. The maximum volume size is 1024 GiB. If you specify a snapshot, the volume size must be equal to or larger than the snapshot size.</p> <p>Default: If you\'re creating the volume from a snapshot and don\'t specify a volume size, the default is the snapshot size.</p>',
    ...
    'LaunchSpecification' => [
      'base' => '<p>Describes the launch specification of a Spot Instance.</p>',
      'refs' => [
    ...
    'OwnerStringList' => [
      'base' => NULL,
      'refs' => [
        'DescribeImagesRequest$Owners' => '<p>Filters the images by the owner. Specify an AWS account ID, <code>amazon</code> (owner is Amazon], <code>aws-marketplace</code> (owner is AWS Marketplace], <code>self</code> (owner is the sender of the request], or <code>all</code> (all owners].</p>',
    ...
    'ProductDescriptionList' => [
      'base' => NULL,
      'refs' => [
        'DescribeSpotPriceHistoryRequest$ProductDescriptions' => '<p>One or more basic product descriptions.</p>',
      ],
    ],
    'PropagatingVgw' => [
    ...
    'SecurityGroupIdStringList' => [
      ...
      'refs' => [
        ...
        'ImportInstanceLaunchSpecification$GroupIds' => NULL,
    ...
    'SpotDatafeedSubscription' => [
      'base' => '<p>Describes the datafeed for a Spot Instance.</p>',
      'refs' => [
        'CreateSpotDatafeedSubscriptionResult$SpotDatafeedSubscription' => '<p>The Spot Instance datafeed subscription.</p>',
        'DescribeSpotDatafeedSubscriptionResult$SpotDatafeedSubscription' => '<p>The Spot Instance datafeed subscription.</p>',
      ],
    ],
    'SpotInstanceRequest' => [
    ...
    'SpotInstanceRequestList' => [
      ...
      'refs' => [
        ...
        'RequestSpotInstancesResult$SpotInstanceRequests' => '<p>Information about the Spot Instance request.</p>',
      ],
    ],
    'SpotInstanceState' => [
      'base' => NULL,
      'refs' => [
        'SpotInstanceRequest$State' => '<p>The state of the Spot Instance request. Spot bid status information can help you track your Spot Instance requests. For information, see <a href="http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances-bid-status.html">Tracking Spot Requests with Bid Status Codes</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>',
      ],
    ],
    ...
    'SpotPrice' => [
      'base' => '<p>Describes the Spot Price.</p>',
      'refs' => [
    ...
    'String' => [
      ...
      'refs' => [
        ...
        'AuthorizeSecurityGroupIngressRequest$IpProtocol' => '<p>The IP protocol name (<code>tcp</code>, <code>udp</code>, <code>icmp</code>] or number (see <a href="http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml">Protocol Numbers</a>]. Use <code>-1</code> to specify all.</p>',
        ...
        'CreateSpotDatafeedSubscriptionRequest$Bucket' => '<p>The Amazon S3 bucket in which to store the Spot Instance datafeed.</p> <p>Constraints: Must be a valid bucket associated with your AWS account.</p>',
        'CreateSpotDatafeedSubscriptionRequest$Prefix' => '<p>A prefix for the datafeed file names.</p>',
        ...
        'DescribeSpotPriceHistoryRequest$AvailabilityZone' => '<p>The Availability Zone.</p>',
        'DescribeSpotPriceHistoryRequest$NextToken' => '<p>The next set of rows to return.</p>',
        'DescribeSpotPriceHistoryResult$NextToken' => '<p>The string marking the next set of results. This is empty if there are no more results.</p>',
        ...
        'LaunchSpecification$SubnetId' => '<p>The ID of the subnet in which to launch the Spot Instance.</p>',
        ...
        'RequestSpotInstancesRequest$SpotPrice' => '<p>The maximum hourly price for any Spot Instance launched to fulfill the request.</p>',
        ...
        'SpotDatafeedSubscription$Bucket' => '<p>The Amazon S3 bucket where the Spot Instance datafeed is located.</p>',
        'SpotDatafeedSubscription$Prefix' => '<p>The prefix that is prepended to datafeed files.</p>',
        'SpotInstanceRequest$SpotInstanceRequestId' => '<p>The ID of the Spot Instance request.</p>',
        'SpotInstanceRequest$SpotPrice' => '<p>The maximum hourly price for any Spot Instance launched to fulfill the request.</p>',
        ...
        'SpotInstanceStatus$Code' => '<p>The status code of the request.</p>',
        'SpotInstanceStatus$Message' => '<p>The description for the status code for the Spot request.</p>',
        ...
        'SpotPrice$SpotPrice' => '<p>The maximum price you will pay to launch one or more Spot Instances.</p>',
        ...
        'RequestSpotLaunchSpecification$SubnetId' => '<p>The ID of the subnet in which to launch the Spot Instance.</p>',
      ],
    ],
    'Subnet' => [
