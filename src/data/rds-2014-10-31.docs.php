<?php return [
  'operations' => [
    ...
    'ApplyPendingMaintenanceAction' => '<p>Applies a pending maintenance action to a resource.</p>',
    ...
    'DeleteDBParameterGroup' => '<p> Deletes a specified DBParameterGroup. The DBParameterGroup to be deleted cannot be associated with any DB instances. </p> <note> The specified DB parameter group cannot be associated with any DB instances. </note>',
  ...
  'shapes' => [
    ...
    'FilterList' => [
      ...
      'refs' => [
        ...
        'DescribePendingMaintenanceActionsMessage$Filters' => '<p>Supported filters:</p> <ul><li> <code>db-instance-id</code> - Accepts DB instance identifiers and DB instance ARNs. The result list will only include maintenance actions for the specified DB Instances.</li></ul>',
    ...
    'PendingMaintenanceActionDetails' => [
      'base' => NULL,
      'refs' => [
        'ResourcePendingMaintenanceActions$PendingMaintenanceActionDetails' => '<p>Provides details about the pending maintenance actions for the resource.</p>',
      ],
    ],
    'PendingMaintenanceActions' => [
      'base' => NULL,
      'refs' => [
        'PendingMaintenanceActionsMessage$PendingMaintenanceActions' => '<p>Provides a list of the pending maintenance actions for the resource.</p>',
      ],
    ],
    ...
    'String' => [
      ...
      'refs' => [
        ...
        'ApplyPendingMaintenanceActionMessage$ResourceIdentifier' => '<p>The ARN of the resource (for example, a DB Instance] that the pending maintenance action applies to.</p>',
        'ApplyPendingMaintenanceActionMessage$ApplyAction' => '<p>The pending maintenance action to apply to this resource.</p>',
        'ApplyPendingMaintenanceActionMessage$OptInType' => '<p>Specify an opt-in request, or undo an opt-in request. An opt-in request of type <code>immediate</code> cannot be undone.</p> <p>Valid values:</p> <ul> <li> <code>immediate</code> - Apply the maintenance action immediately.</li> <li> <code>next-maintenance</code> - Apply the maintenance action during the next maintenance window for the resource.</li> <li> <code>undo-opt-in</code> - Cancel any existing <code>next-maintenance</code> opt-in requests.</li> </ul>',
        ...
        'DescribePendingMaintenanceActionsMessage$ResourceIdentifier' => '<p>The ARN of the resource to return pending maintenance actions for.</p>',
        ...
        'ResourcePendingMaintenanceActions$ResourceIdentifier' => '<p>The ARN of this resource that has pending maintenance actions.</p>',
    ...
    'TStamp' => [
      ...
      'refs' => [
        ...
        'PendingMaintenanceAction$CurrentApplyDate' => '<p>The effective date when the pending maintenance action will be applied to the resource. This takes into account opt-in requests received from the <a>ApplyPendingMaintenanceAction</a> API, the <code>AutoAppliedAfterDate</code>, and the <code>ForcedApplyDate</code>. This value is blank if an opt-in request has not been received and no value has been specified for the <code>AutoAppliedAfterDate</code> or <code>ForcedApplyDate</code>.</p>',
