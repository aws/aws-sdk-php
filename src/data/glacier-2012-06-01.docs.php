<?php return [
  ...
  'shapes' => [
    ...
    'string' => [
      'base' => NULL,
      'refs' => [
        'AbortMultipartUploadInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'CompleteMultipartUploadInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'DeleteArchiveInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        'DeleteArchiveInput$vaultName' => '<p>The name of the vault.</p>',
        'DeleteArchiveInput$archiveId' => '<p>The ID of the archive to delete.</p>',
        'DeleteVaultInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        'DeleteVaultInput$vaultName' => '<p>The name of the vault.</p>',
        'DeleteVaultNotificationsInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        'DeleteVaultNotificationsInput$vaultName' => '<p>The name of the vault.</p>',
        'DescribeJobInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        'DescribeJobInput$vaultName' => '<p>The name of the vault.</p>',
        'DescribeJobInput$jobId' => '<p>The ID of the job to describe.</p>',
        'DescribeVaultInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'GetVaultNotificationsInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'InitiateMultipartUploadInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'ListJobsInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'ListMultipartUploadsInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'ListPartsInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'ListVaultsInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'SetDataRetrievalPolicyInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include the dashes in it. </p>',
        'SetVaultNotificationsInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        'SetVaultNotificationsInput$vaultName' => '<p>The name of the vault.</p>',
        'UploadArchiveInput$vaultName' => '<p>The name of the vault.</p>',
        'UploadArchiveInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
        ...
        'UploadMultipartPartInput$accountId' => '<p>The <code>AccountId</code> is the AWS Account ID. You can specify either the AWS Account ID or optionally a \'-\', in which case Amazon Glacier uses the AWS Account ID associated with the credentials used to sign the request. If you specify your Account ID, do not include hyphens in it. </p>',
