<?php return [
  ...
  'shapes' => [
    ...
    'EnvironmentVariables' => [
      'base' => NULL,
      'refs' => [
        'App$Environment' => '<p>An array of <code>EnvironmentVariable</code> objects that specify environment variables to be associated with the app. You can specify up to ten environment variables. After you deploy the app, these variables are defined on the associated app server instances.</p>',
        'CreateAppRequest$Environment' => '<p>An array of <code>EnvironmentVariable</code> objects that specify environment variables to be associated with the app. You can specify up to ten environment variables. After you deploy the app, these variables are defined on the associated app server instance.</p> <note>This parameter is supported only by Chef 11.10 stacks. If you have specified one or more environment variables, you cannot modify the stack\'s Chef version.</note>',
        'UpdateAppRequest$Environment' => '<p>An array of <code>EnvironmentVariable</code> objects that specify environment variables to be associated with the app. You can specify up to ten environment variables. After you deploy the app, these variables are defined on the associated app server instances.</p> <note>This parameter is supported only by Chef 11.10 stacks. If you have specified one or more environment variables, you cannot modify the stack\'s Chef version.</note>',
      ],
    ],
    ...
    'RootDeviceType' => [
      ...
      'refs' => [
        ...
        'Instance$RootDeviceType' => '<p>The instance root device type. For more information, see <a href="http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ComponentsAMIs.html#storage-for-the-root-device">Storage for the Root Device</a>.</p>',
    ...
    'String' => [
      ...
      'refs' => [
        ...
        'CloneStackRequest$DefaultSshKeyName' => '<p>A default SSH key for the stack instances. You can override this value when you create or update an instance.</p>',
        ...
        'CreateInstanceRequest$SshKeyName' => '<p>The instance SSH key name.</p>',
        ...
        'CreateStackRequest$DefaultSshKeyName' => '<p>A default SSH key for the stack instances. You can override this value when you create or update an instance.</p>',
        ...
        'DeregisterVolumeRequest$VolumeId' => '<p>The volume ID.</p>',
        ...
        'Instance$SshKeyName' => '<p>The instance SSH key name.</p>',
        ...
        'Stack$DefaultSshKeyName' => '<p>A default SSH key for the stack\'s instances. You can override this value when you create or update an instance.</p>',
        ...
        'UpdateInstanceRequest$SshKeyName' => '<p>The instance SSH key name.</p>',
        'UpdateLayerRequest$LayerId' => '<p>The layer ID.</p>',
        'UpdateLayerRequest$Name' => '<p>The layer name, which is used by the console.</p>',
        'UpdateLayerRequest$Shortname' => '<p>The layer short name, which is used internally by AWS OpsWorksand by Chef. The short name is also used as the name for the directory where your app files are installed. It can have a maximum of 200 characters and must be in the following format: /\\A[a-z0-9\\-\\_\\.]+\\Z/.</p>',
        ...
        'UpdateStackRequest$DefaultSshKeyName' => '<p>A default SSH key for the stack instances. You can override this value when you create or update an instance.</p>',
