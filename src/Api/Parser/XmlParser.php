...
class XmlParser
{
    ...
    {
        // `xmlNamespace` can be modeled as a string.  When modeled as an object,
        // it is guaranteed to have a `uri` field.
        $namespace = $shape['xmlNamespace']['uri'] ?? $shape['xmlNamespace'] ?? '';
