 ...
 *
 * Implementers must also implement `serialize()` and `resolveBlob()` according to
 * their respective protocol specifications.
 *
 * @internal
 */
                ...
                if (!($value instanceof DateTimeInterface)) {
                    ...
                    try {
                        ...
                        throw new AwsException(
                            'Request serialization failed: Invalid date/time: ' . $e->getMessage(),
                            $e->getCode(),
                            $e
                        );
                    }
