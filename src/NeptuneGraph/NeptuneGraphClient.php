 ...
 * @phpstan-method \Aws\Result listImportTasks(array{graphIdentifier?: string, nextToken?: string, maxResults?: int, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listImportTasksAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listImportTasksAsync(array{graphIdentifier?: string, nextToken?: string, maxResults?: int, ...} $args = [])
