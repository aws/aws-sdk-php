 ...
 * @method \Aws\Result describeDBLogFiles(array $args = []) (supported in versions 2013-02-12, 2013-09-09, 2014-09-01, 2014-10-31)
 * @method \GuzzleHttp\Promise\Promise describeDBLogFilesAsync(array $args = []) (supported in versions 2013-02-12, 2013-09-09, 2014-09-01, 2014-10-31)
 * @method \Aws\Result downloadDBLogFilePortion(array $args = []) (supported in versions 2013-02-12, 2013-09-09, 2014-09-01, 2014-10-31)
 * @method \GuzzleHttp\Promise\Promise downloadDBLogFilePortionAsync(array $args = []) (supported in versions 2013-02-12, 2013-09-09, 2014-09-01, 2014-10-31)
 * @method \Aws\Result copyDBParameterGroup(array $args = []) (supported in versions 2014-09-01, 2014-10-31)
 * @method \GuzzleHttp\Promise\Promise copyDBParameterGroupAsync(array $args = []) (supported in versions 2014-09-01, 2014-10-31)
 * @method \Aws\Result copyOptionGroup(array $args = []) (supported in versions 2014-09-01, 2014-10-31)
 * @method \GuzzleHttp\Promise\Promise copyOptionGroupAsync(array $args = []) (supported in versions 2014-09-01, 2014-10-31)
