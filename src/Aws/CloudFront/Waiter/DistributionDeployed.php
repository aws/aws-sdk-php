...
/**
 * Returns true when the distribution is deployed
 */
class DistributionDeployed extends AbstractResourceWaiter
{
    ...
    {
        $result = $this->client->getCommand('GetDistribution', array(
            'Id'        => $this->resourceId,
            Ua::OPTION  => Ua::WAITER
        ))->execute();
