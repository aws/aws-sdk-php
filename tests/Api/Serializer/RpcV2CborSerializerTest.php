...
class RpcV2CborSerializerTest extends TestCase
{
    ...
    public function testSerializesTimestamp(): void
    {
        ...
        $expected = ['createdAt' => $timestamp->getTimestamp()];
        $this->assertSame($expected, $decoded);
    }

    public function testSerializesDateTimeImmutable(): void
    {
        $timestamp = new DateTimeImmutable('2024-01-15 10:30:00 UTC');
        $request = $this->getRequest('OperationWithTimestamp', [
            'createdAt' => $timestamp,
        ]);
