...
class ComplianceTest extends TestCase
{
    ...
    private static array $excludedCases = [
        ...
        'FlattenedXmlMap' => true,
        'FlatNestedXmlMapRequest' => true,
        'NullAndEmptyHeaders' => true,
        'RestJsonHttpChecksumRequired' => true,
        'MediaTypeHeaderInputBase64' => true,
        'QueryFlattenedListArgWithXmlName' => true,
        'BodyWithXmlName' => true,
        'FlattenedXmlMapWithXmlName' => true,
        'RestXmlHttpPayloadWithUnion' => true,
        'HttpPayloadWithXmlName' => true,
        'HttpPayloadWithXmlNamespace' => true,
        'HttpPayloadWithXmlNamespaceAndPrefix' => true,
        'NestedXmlMapWithXmlNameSerializes' => true,
    ...
    private function assertXmlEquals($expected, $actual, $message = ''): void
    {
    ...
    private function isValidXml(string $string)
    {
    ...
    private function isDateHeader($value): int|false
    {
        // Match common HTTP date format
        return preg_match('/^\w{3},\s+\d{1,2}\s+\w{3}\s+\d{4}\s+\d{2}:\d{2}:\d{2}\s+GMT$/', $value);
    }
}
